...
export class ProductDetail extends BaseCreatedByEntity {
    @OneToMany(() => ProductAttributeDefault, (productAttributeDefault) => productAttributeDefault.productDetailId)
    ...
    @OneToMany(() => AttributeProductValue, (attributeProductValue) => attributeProductValue.productDetailId)
